defmodule Kafee.Telemetry.DataStreams.AggregatorPoint do
  @moduledoc """
  A single point of data determined from a Kafka message. This
  can be aggregated to a `Kafee.Telemetry.DataStreams.StatsPoint`.
  """
